var NewGameYet = localStorage.bClick22;
var AllB = [
...
function ShowHideAchievements() {
    var list = document.getElementById("AchievementsList");
    list.style.display = (list.style.display != 'none' ? 'none' : '' );
}

if (!isMobile.any()) {
    var list = document.getElementById("minimizeAchievements");
    list.setAttribute("onclick", "ShowHideAchievements()");
}
