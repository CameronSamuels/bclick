...
//         id("main").style.opacity = "0.3";
//         id("tutorial").style.opacity = "100";
//         id(tutorial.steps[tutorial.step].object).style.opacity = "100";
...
var data = {
    ...
    load : function() {
        if (get("played326") == undefined) {
            // set("played326Tut", "false");
            data.reset.hard();   
        }
        // if (get("played326Tut") == "false") {
        //     tutorial.start();
        // }
    }
}
