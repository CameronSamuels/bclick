...
var data = {
    reset : {
        ...
        hard : function() {
            ...
            if (get("multiplier") !== undefined && get("multiplier") !== 'NaN' && get("multiplier") >= 4) set('multiplier', (get("multiplier") * 0.05)); 
    ...
    load : function() {
        if (get("points") === undefined) data.reset.hard();
            ...
            msg('bClick Offline Earnings', 'While you were away, you earned ' + ((get('interest') * 0.05) * timeSince(get('lastPlay'))) + ' points!');
        }
