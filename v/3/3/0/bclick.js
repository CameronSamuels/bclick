...
var achievements = {
    ...
    achieve : function(id) {
        ...
        // if (!isMobile.any()) {
        //     if (confirm('Do you want to tell your FB friends about your achievement?') == true) {
        //         FB.ui({
        //           method: 'share',
        //           display: 'popup',
        //           href: 'https://playbclick.com',
        //           hashtag: '#bClick',
        //           quote: 'I just unlocked the ' + achievements.list.spaces[achievements.list.id.indexOf(id)] + ' achievement in the game called bClick. Hurray!'
        //         }, function(response){
        //             if (response && !response.error_code) {
        //                 Earn(get("points") * 0.2);
        //                 msg("You earned points", "You have earned" + (get("points") * 0.2) + "for sharing to Facebook");
    ...
    refresh : function() {
        ...
        if (localStorage.getItem(b.list.list[get("bPosition")]) == 'false') {
            ...
            if (isMobile.any()) {
                ...
                b.vars.unlock().innerHTML = "Unlocked! Click to share";
            }
        }
