...
b.list.b.lowercase = new create('lowercase', 5, 250, "#999");
b.list.b.regular = new create('regular', 25, 1000, "#333");
b.list.b.saw = new create('saw', 75, 7500, "#F00");
b.list.b.spiky = new create('spiky', 150, 30000, "#FF0080");
b.list.b.electric = new create('electric', 500, 60000, "#FFA500");
b.list.b.thin = new create('thin', 2000, 120000, "#CCC");
b.list.b.curved = new create('curved', 5000, Math.pow(10, 6), "#0FF");
b.list.b.shark = new create('shark', 10000, Math.pow(10, 7), "#33B");
b.list.b.fancy = new create('fancy', 25000, Math.pow(10, 8), "#DDD");
b.list.b.lightning = new create('lightning', 75000, Math.pow(10, 9), "#FF0");
b.list.b.awesome = new create('awesome', 125000, Math.pow(10, 10), "#909");
b.list.b.thirteen = new create('thirteen', 250000, Math.pow(10, 11), "#555555");
b.list.b.golden = new create('golden', Math.pow(10, 7), Math.pow(10, 12), "#FFD700");
b.list.b.pattern = new create('pattern', Math.pow(10, 8), Math.pow(10, 13), " patternB");
b.list.b.gradient = new create('gradient', Math.pow(10, 9), Math.pow(10, 14), " gradientB");
b.list.b.disco = new create('disco', Math.pow(10, 10), Math.pow(10, 15), " discoB");
b.list.b.knight = new create('knight', Math.pow(10, 11), Math.pow(10, 16), "#614126");
b.list.b.archer = new create('archer', Math.pow(10, 12), Math.pow(10, 17), "#005900");
b.list.b.barbed = new create('barbed', Math.pow(10, 13), Math.pow(10, 18), "#191919");
b.list.b.flower = new create('flower', Math.pow(10, 14), Math.pow(10, 19), "#b266b2");
b.list.b.muscle = new create('muscle', Math.pow(10, 15), Math.pow(10, 20), "#00ff00");
b.list.b.bw = new create('bw', Math.pow(10, 17), Math.pow(10, 21), "#000000");
b.list.b.honeycomb = new create('honeycomb', Math.pow(10, 17), Math.pow(10, 22), "#ffff00");
b.list.b.creative = new create('creative', Math.pow(10, 18), Math.pow(10,23), "#ffb30d");
b.list.b.rubiks = new create('rubiks', Math.pow(10, 19), Math.pow(10, 24), " rubiksB");
b.list.b.star = new create('star', Math.pow(10, 20), Math.pow(10, 25), "#000000");
b.list.b.impossible = new create('impossible', Math.pow(10, 21), Math.pow(10, 26), "#666666");
b.list.b.ghost = new create('ghost', Math.pow(10, 22), Math.pow(10, 27), "#444444");
b.list.b.poke = new create('poke', Math.pow(10, 23), Math.pow(10, 28), "#FF0000");
b.list.b.chalk = new create('chalk', Math.pow(10, 24), Math.pow(10, 29), "#000000");
b.list.b.giant = new create('giant', Math.pow(10, 25), Math.pow(10, 30), "#6D3200");
b.list.b.election = new create('election', Math.pow(10, 26), Math.pow(10, 31), "#0000FF");
b.list.b.baseball = new create('baseball', Math.pow(10, 27), Math.pow(10, 32), "#6D3200");
b.list.b.picasso = new create('picasso', Math.pow(10, 28), Math.pow(10, 33), "#F633F6");
b.list.b.challah = new create('challah', Math.pow(10,29), Math.pow(10, 34), "#6D3200");
b.list.b.spear = new create('spear', Math.pow(10,30), Math.pow(10, 35), "#343434");
b.list.b.superhero = new create('superhero', Math.pow(10, 31), Math.pow(10, 36), "#3333FF");
b.list.b.duck = new create('duck', Math.pow(10, 32), Math.pow(10, 37), "#33EE33");
b.list.b.dragonball = new create('dragonball', Math.pow(10, 33), Math.pow(10, 38), "#FFD700");
b.list.b.nature = new create('nature', Math.pow(10, 34), Math.pow(10, 39), "#6D3200");
b.list.b.dovahkinn = new create('dovahkinn', Math.pow(10, 35), Math.pow(10, 40), "#FFFF00");
b.list.b.mage = new create('mage', Math.pow(10, 99), Math.pow(10, 41), "#FF33FF");
b.list.b.carnotaurus = new create('carnotaurus', Math.pow(10, 37), Math.pow(10, 42), "#FF1111");
b.list.b.business = new create('business', Math.pow(10, 38), Math.pow(10, 43), "#FF88FF");
b.list.b.killer = new create('killer', Math.pow(10, 39), Math.pow(10, 44), "#FF1111");
b.list.b.candycane = new create('candycane', Math.pow(10, 40), Math.pow(10, 45), "#FF0000");
b.list.b.year3 = new create('year3', Math.pow(10, 41), Math.pow(10, 46), "#FFFF00");
b.list.b.skater = new create('skater', Math.pow(10, 42), Math.pow(10, 47), "#6D3200");
b.list.b.orchestral = new create('orchestral', Math.pow(10, 43), Math.pow(10, 48), "#6D3200");
b.list.b.phone = new create('phone', Math.pow(10, 50), Math.pow(10, 52), "#000000");
